...
📖 **Быстрый деплой в облако**: см. [DEPLOY_QUICKSTART.md](./DEPLOY_QUICKSTART.md)
...
📖 **Быстрый старт**: [DEPLOY_QUICKSTART.md](./DEPLOY_QUICKSTART.md) - деплой на Railway за 5 минут

### 📚 Подробная документация

- [DEPLOY.md](./DEPLOY.md) - полное руководство по деплою на Railway, Render, Fly.io, DigitalOcean
